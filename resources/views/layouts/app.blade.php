<html lang="en"><head>
  ...
  <body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center header-scrolled">
      ...
      <div class="d-flex align-items-center justify-content-between">
        <a href="{{route('dashboard')}}" class="logo d-flex align-items-center">
          <img src="{{asset('images/zesa-removebg-preview.png')}}" alt="">
          <span class="d-none d-lg-block">ZEDTC</span>
        </a>
    ...
    <footer id="footer" class="footer">
      <div class="copyright">
        © Copyright <strong><span>ZEDTC Biometric Attendance Management</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="#">ZEDTC</a>
      </div>
    </footer><!-- End Footer -->
